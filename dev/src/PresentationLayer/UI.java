...
public class UI {
    ...
    private void employeeLoginMenu() {
        ...
        Employee employee = ControllerManager.getHRManager().FindEmployeeByID(id);
        ...
        while (true) {
            ...
            switch (EmployeeChoice) {
                case "1":
                    ControllerEmployee.viewMyShifts(employee, ControllerManager.getHRManager());
                    break;
                case "2":
    ...
    private void EmployeeManagementDisplay(Scanner sc) {
        HRManager hr = ControllerManager.getHRManager();
        ...
        switch (empChoice) {
            case "1":
                ControllerManager.addNewEmployee(sc);
                break;
            case "2":
                ControllerManager.removeEmployeeById(sc);
                break;
            case "3":
                ControllerManager.addNewRoleToEmployee(sc);
                break;
            case "4":
                ControllerManager.editEmployee(sc);
                break;
            case "5":
                ControllerManager.printEmployeeById(sc);
                break;
            case "6":
                hr.printEmployees();
                break;
    ...
    private void RoleAndShiftManagementDisplay(Scanner sc) {
        ...
        switch (roleChoice) {
            case "1":
                ControllerManager.addNewRole(sc);
                break;
            case "2":
                ControllerManager.createShiftsForTheWeek(sc);
                break;
            case "3":
                ControllerManager.defineRolesForSpecificShift(sc);
                break;
            case "4":
                hr.printRoles();
                break;
    ...
    private void ShiftAssignmentDisplay(Scanner sc) {
        while (true) {
            ...
            switch (assignChoice) {
                case "1":
                    ControllerManager.assignEmployeeToShift(sc);
                    break;
                case "2":
                    ControllerManager.removeEmployeeFromShift(sc);
                    break;
                case "3":
                    ControllerManager.viewAssignedShifts();
                    break;
                case "0":
                    return;
                default:
    ...
    private void archiveDisplay(Scanner sc) {
        while (true) {
            ...
            switch (assignChoice) {
                case "1":
                    ControllerManager.displayArchivedShifts();
                    break;
                case "2":
                    ControllerManager.displayArchivedEmployees();
                    break;
                case "0":
                    return;
                default:
