            ...
            try (Statement st = conn.createStatement()) {
                ...
                st.executeUpdate("""
                    CREATE TABLE IF NOT EXISTS drivers (
                        id TEXT PRIMARY KEY,
                        license_type TEXT CHECK(license_type IN ('B','C','C1','C2','E')) NOT NULL,
                ...
                st.executeUpdate("""
                    CREATE TABLE IF NOT EXISTS transports (
                        ...
                        status TEXT CHECK(status IN ('PLANNED', 'DISPATCHED', 'COMPLETED', 'CANCELLED', 'SELFDELIVERY')) NOT NULL,
                ...
                st.executeUpdate("""
                    CREATE TABLE IF NOT EXISTS destination_docs (
                        ...
                        status TEXT CHECK(status IN ('PENDING', 'DELIVERED', 'IN_DELIVERY', 'CANCELLED')) NOT NULL,
                        delivery_date TEXT,
                ...
                st.executeUpdate("""
                    CREATE TABLE IF NOT EXISTS delivered_items (
                        ...
                        status TEXT CHECK(status IN ('CANCELLED', 'PENDING', 'SHIPPED', 'RECEIVED')) NOT NULL,
